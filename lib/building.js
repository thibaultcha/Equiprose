...
module.exports = {
    ...
    buildSite: function (siteConfig, callback) {
        ...
        this.prepareOutputDir(siteConfig.paths.buildDir, siteConfig.paths.assets.input, siteConfig.paths.assets.output, function (err) {
            ...
            // Stylesheets
            self.compileStylesheets(siteConfig.paths.templateDir, siteConfig.paths.assets.output, function (err) {
                if (err) return callback(err)
    ...
    compileStylesheets: function (stylPath, outputCss, callback) {
