...
exports.buildSite = function (sitePath, callback) {
	...
	prepareOutputDir(siteConfig.buildDir, path.join(sitePath, globalConfig.assets.input), path.join(siteConfig.buildDir, globalConfig.assets.output), function (err) {
